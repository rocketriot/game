...
public class MainMenuScreen extends ScreenMaster {
  ...
  private void drawButtons() {
    ...
    addListener(
        hostButton,
        new BaseClickListener(hostButton, Assets.hostButton, Assets.hostButtonHover) {
          @Override
    ...
    addListener(
        joinButton,
        new BaseClickListener(joinButton, Assets.joinButton, Assets.joinButtonHover) {
          @Override
          public void clicked(InputEvent event, float x, float y) {
            SoundController.playSound("menuSelect");
    ...
    addListener(
        howToPlayButton,
        new BaseClickListener(
            howToPlayButton, Assets.howToPlayButton, Assets.howToPlayButtonHover) {
          @Override
          public void clicked(InputEvent event, float x, float y) {
            SoundController.playSound("menuSelect");
    ...
    addListener(
        preferencesButton,
        new BaseClickListener(
            preferencesButton, Assets.preferencesButton, Assets.preferencesButtonHover) {
          @Override
          public void clicked(InputEvent event, float x, float y) {
            SoundController.playSound("menuSelect");
    ...
    addListener(
        exitButton,
        new BaseClickListener(exitButton, Assets.exitButton, Assets.exitButtonHover) {
          @Override
          public void clicked(InputEvent event, float x, float y) {
            SoundController.playSound("menuSelect");
            Gdx.app.exit();
