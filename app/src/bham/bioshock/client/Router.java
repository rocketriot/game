...
public class Router {
  ...
  /**
   * Prebuild the routing This method will find appropriate method in the controller, display any
   * issues in the console and cache methods in the HashMap so they can be found easily later
   */
