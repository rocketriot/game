...
/**
 * Bullets are created when a player with a gun is shooting They are usually travelling with high
 * speed
 */
public class Bullet extends Entity {
  ...
  /**
   * Spawn new bullet for a player shooting it Adjust the speed vector accordingly
   *
   * @param world
   * @param player
   * @return
